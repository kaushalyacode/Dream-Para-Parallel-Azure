              ...
              <div class="box">
                <form method="get" action="checkout3.php">
                        ...
                        <div class="box shipping-method">
                          ...
                          <div class="box-footer">
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" value="" onclick="validator()" id="defaultCheck1">
                  ...
                  <div class="box-footer d-flex justify-content-between"><a href="checkout1.php" class="btn btn-outline-secondary"><i class="fa fa-chevron-left"></i>Back to address</a>
                    <button type="submit" class="btn btn-primary" id="con">Continue to Payment Method<i class="fa fa-chevron-right"></i></button>
                  </div>
                </form>
              </div>
              <!-- /.box-->
