                        ...
                        <div class="card sidebar-menu mb-4">
                            ...
                            <div class="card-body">
                                <ul class="nav nav-pills flex-column category-menu">
                                    <li>
                                        <a href="category.php" class="nav-link">Men <span class="badge badge-secondary">42</span></a>
                                    ...
                                    <li>
                                        <a href="category.php" class="nav-link active">Ladies  <span class="badge badge-light">123</span></a>
                                        <ul class="list-unstyled">
                                            <li><a href="category.php" class="nav-link">T-shirts</a></li>
