                                   ...
                                   <?php
                                    ...
                                    <a href="customer-account.php" class="nav-link active">
                                        <i class="fa fa-user"></i> 
                                             My account
                                    <a href="customer-ad-info.php" class="nav-link">
                                    ...
                                    ?>
                    <ul class="nav nav-pills flex-column"><a href="customer-orders.php" class="nav-link ">
                    <i class="fa fa-list"></i>Purchase History</a><a href="customer-wishlist.php" class="nav-link"><i class="fa fa-heart"></i> My wishlist</a><a href="customer-account.php" class="nav-link active"><i class="fa fa-user"></i> My account</a><a href="index.php" class="nav-link"><i class="fa fa-sign-out"></i> Logout</a></ul>
