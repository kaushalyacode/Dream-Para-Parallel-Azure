                    ...
                    <div id="checkout" class="col-lg-9">
                        <div class="box">
                            <form method="get" action="checkout2.php">
                                ...
                                <div class="nav flex-column flex-md-row nav-pills text-center"><a href="checkout1.php" class="nav-link flex-sm-fill text-sm-center active"> <i class="fa fa-map-marker">                  </i>Address</a><a href="#" class="nav-link flex-sm-fill text-sm-center disabled"> <i class="fa fa-truck">                       </i>Legal Documents</a><a href="#" class="nav-link flex-sm-fill text-sm-center disabled"> <i class="fa fa-money">                      </i>Payment Method</a><a href="#" class="nav-link flex-sm-fill text-sm-center disabled"> <i class="fa fa-eye">                     </i>Order Review</a></div>
                                <div class="content py-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="firstname">Firstname</label>
                                                <input id="firstname" disabled type="text" value class="form-control" value="<?php echo $_SESSION['fname'];?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="lastname">Lastname</label>
                                                <input id="lastname" disabled type="text" value="<?php echo $_SESSION['lname'];?>" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.row-->
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="nic" type="text" value="<?php echo $_SESSION['nic'];?>" disabled class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="email">Email</label>
                                                <input id="email" value="<?php echo $_SESSION['email'];?>" type="email" disabled class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.row-->
                                    <div class="row">
                                        <div class="col-md-6 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input id="username" value="<?php echo $_SESSION['tenent'];?>" disabled type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-3">
                                            <div class="form-group">
                                                <label for="tel">Tel</label>
                                                <input id="tel" disabled value="<?php echo $_SESSION['tel'];?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-3">
                                            <div class="form-group">
                                                <label for="mobile">Mobile</label>
                                                <input id="mobile" disabled value="<?php echo $_SESSION['mobile'];?>" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-3 invisible">
                                            <div class="form-group">
                                                <label for="country">Country</label>
                                                <select id="country" disabled class="form-control"></select>
                                            </div>
                                        </div>
                                ...
                                <div class="box-footer d-flex justify-content-between">
                                    <a href="basket.php" class="btn btn-outline-secondary"><i class="fa fa-chevron-left"></i>Back to Basket</a>
